...
```{r Loading_Preprocessing_Data, echo=TRUE}
...
The 5-minute interval with the highest number of steps averaged across all days is **`r maxTime`**  
...
**Mean** Total Steps per Day = **`r imputedMeanSteps`**  
**Median** Total Steps per Day = **`r imputedMedianSteps`**  
...
```{r weekday_analysis, fig.height=8, echo=TRUE}
